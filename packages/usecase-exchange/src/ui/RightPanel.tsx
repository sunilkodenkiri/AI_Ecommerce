...
export default function RightPanel() {
  ...
  useEffect(()=>{
    const onOffer = (p:any)=>{
      ...
      setTimeout(()=>{
        ...
        const payload = { sessionId, vendorId: "EXCHANGER-PANEL", price: val, etaHours: 24 };
  ...
  return (
    <div className="p-4 border rounded-lg bg-white/5">
      <h3 className="font-semibold mb-2">Exchanger Panel</h3>
      <div className="space-y-2">
        {offers.length===0 && <div className="text-sm opacity-70">Waiting for exchangers…</div>}
